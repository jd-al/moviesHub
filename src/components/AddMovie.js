  ...
  const addMovie = async () => {
    try {
      ...
      if (useAppState.login) {
        await addDoc(moviesRefrence, form);
        swal({
              ...
              <div className="p-2 w-full">
                <div className="relative">
                  ...
                  <textarea
                    ...
                    className="w-full bg-gray-100 bg-opacity-90 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 h-32 text-base outline-none text-black py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out"
                  ></textarea>
                </div>
              </div>
              <div className="p-2 w-full">
